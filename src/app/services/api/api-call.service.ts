...
export class ApiCallService {
  ...
  verifyOtp(item, sessionId: string): Observable<String> {
    ...
    return this.http
      .post<String>(this.base_path + "/otp/verify", JSON.stringify(item), {
        headers: headers,
      })
      .pipe(catchError(this.handleError));
  }
  ...
  storeProfileData(data): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(this.base_path + "/client", JSON.stringify(data), {
        headers: headers,
      })
      .pipe(catchError(this.handleError));
  }
  ...
  updateProfileData(data, c_id): Observable<JSON> {
    let headers = new HttpHeaders().set("Content-Type", "application/json");
    return this.http
      .put<JSON>(this.base_path + `/client/${c_id}`, JSON.stringify(data), {
        headers: headers,
      })
      .pipe(catchError(this.handleError));
  }
  ...
  storeFoodData(data, c_id): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + `/calorieTracker/${c_id}`,
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  getUserFoodData(toDate, fromDate, c_id): Observable<JSON> {
    return this.http
      .get<JSON>(
        this.base_path +
          `/calorieTracker/${c_id}?toDate=${toDate}&fromDate=${fromDate}`
      )
      .pipe(catchError(this.handleError));
  }
  ...
  updateFoodItem(data, c_id, co_id): Observable<JSON> {
    ...
    return this.http
      .put<JSON>(
        this.base_path + `/updateTracker/${c_id}/${co_id}`,
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  deleteFoodItem(c_id, co_id): Observable<JSON> {
    return this.http
      .delete<JSON>(
        this.base_path + `/deleteCaloreConsumption/${c_id}/${co_id}`
      )
      .pipe(catchError(this.handleError));
  }
  ...
  searchHandwashTrackerData(data): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + `/handwashtracker/search/`,
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  storeHandwashTrackerData(data): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + `/handwashtracker/addupdate/`,
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  post(payload, endponit): Observable<JSON> {
    let headers = new HttpHeaders().set("Content-Type", "application/json");
    return this.http
      .post<JSON>(this.base_path + endponit, JSON.stringify(payload), {
        headers: headers,
      })
      .pipe(catchError(this.handleError));
  }
  ...
  getMyTrainingData(category, plan, c_id): Observable<JSON> {
    return this.http
      .get<JSON>(
        this.base_path + `/mytraining/getData/${category}/${plan}/${c_id}`
      )
      .pipe(catchError(this.handleError));
  }
  ...
  gettingStartedData(data): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + `/mytraining/createTraining`,
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  workoutSchedule(data): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + `/mytraining/workoutSchedule`,
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  getMyTrainingOverviewData(c_id): Observable<JSON> {
    return this.http
      .get<JSON>(
        this.base_path + `/mytraining/getTrainingWorkoutSchedule/${c_id}`
      )
      .pipe(catchError(this.handleError));
  }
  ...
  getDayWiseData(day, week, c_id): Observable<JSON> {
    return this.http
      .get<JSON>(
        this.base_path + `/mytraining/getDayVideo/${c_id}/${day}/${week}`
      )
      .pipe(catchError(this.handleError));
  }
  ...
  getPaymentId(data): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + "/payment/create_order",
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  scheduleAppointment(data): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + "/dietcian/bookAppoitment",
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  updateUserPlan(data, c_id): Observable<JSON> {
    ...
    return this.http
      .put<JSON>(
        this.base_path + `/UpdateclientId/${c_id}`,
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  storeDayWiseSeenVideo(data: any): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + "/mytraining/storeworkout",
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  storeDayWiseCalorieConsumtion(data: any): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + "/calorie/storeDayWiseCalorie",
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
  ...
  getDayWiseCalorieConsumtion(data: any): Observable<JSON> {
    ...
    return this.http
      .post<JSON>(
        this.base_path + "/calorie/getDayWiseCalorie",
        JSON.stringify(data),
        { headers: headers }
      )
      .pipe(catchError(this.handleError));
