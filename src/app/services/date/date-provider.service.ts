    ...
    switch (type) {
      case 'water': {
        const currentData = {
          wt_goal: 8,
          wt_achived: 0,
          wt_date: date.format(('DD/MM/YYYY')),
          wt_date_graphFormat: date.format('ddd DD'),
          wt_unit: 250
        }
        return currentData;
      }
      case 'weight': {
        const currentData = {
          wet_goal: 0,
          wet_currentweight: 0,
          wet_date: date.format(('DD/MM/YYYY')),
          wet_date_graphFormat: date.format('ddd DD'),
